...
You are an autonomous web agent that completes tasks by interacting with web pages.

Your task is to filter the incident list.
...
- press(bid, key): Press a keyboard key
- scroll(x, y): Scroll the page
- go_back(): Navigate back
- go_forward(): Navigate forward

Below is a HUMAN DEMONSTRATION of a similar task. Learn from this example:
...
Task ID: workarena.servicenow.filter-incident-list
Starting URL: https://empmassimo23.service-now.com/now/nav/ui/classic/params/target/incident_list.do
Total Steps: 10

## GOAL
Filter a list based on specific criteria using the filter interface.
...
**Code:** `click("189")`
**Element:** role="list", name="All"
**Why:** Clicking on the list view to ensure focus

### Step 2/10
**Action:** Click on button "Show / hide filter"
**Code:** `click("iframe0_48")`
**Element:** role="button", name="Show / hide filter"
**Why:** Opening the filter panel to add conditions

### Step 3/10
**Action:** Click on button "-- choose field --"
**Code:** `click("role-button")`
**Element:** role="button", name="-- choose field --"
**Why:** Opening the field selector dropdown

### Step 4/10
**Action:** Type "Prio" into combobox (bid=id-s2id-autogen2-search)
**Code:** `fill("id-s2id-autogen2-search", "Prio")`
**Element:** role="combobox", name=""
**Why:** Typing to search/filter the dropdown options

### Step 5/10
**Action:** Click on option "Priority"
**Code:** `click("id-select2-result-label-166")`
**Element:** role="option", name="Priority"
**Why:** Selecting the matching option from the filtered list

### Step 6/10
**Action:** Select option "1" from combobox "Choose option for field: Priority"
**Code:** `select_option("aria-choose-option-for-field--priority", "1")`
**Element:** role="combobox", name="Choose option for field: Priority"
**Why:** Opening the field selector dropdown

### Step 7/10
**Action:** Click on button "Add AND Condition To Condition 1: Priority is 1 - Critical"
**Code:** `click("aria-add-and-condition-to-condition-1--priority-is-1---critical")`
**Element:** role="button", name="Add AND Condition To Condition 1: Priority is 1 - Critical"
**Why:** Adding the filter condition to the query

### Step 8/10
**Action:** Click on "Unfiltered Incidents list showing 1 to 20 of 88 re"
**Code:** `click("iframe0_34")`
**Element:** role="", name="Unfiltered Incidents list showing 1 to 20 of 88 re"
**Why:** Opening the filter panel to add conditions

### Step 9/10
**Action:** Type "Cate" into combobox (bid=id-s2id-autogen168-search)
**Code:** `fill("id-s2id-autogen168-search", "Cate")`
**Element:** role="combobox", name=""
**Why:** Typing to search/filter the dropdown options

### Step 10/10
**Action:** Click on option "Category"
**Code:** `click("id-select2-result-label-464")`
**Element:** role="option", name="Category"
**Why:** Selecting the matching option from the filtered list

## KEY PATTERNS

- **Filter Pattern:** Search → Select from dropdown → Apply
- **Type-ahead Search:** Type partial text in combobox to filter options
- **Iframe Handling:** Some elements are inside iframes

## HOW TO USE THIS DEMONSTRATION
1. Identify similar UI elements by their role and name
2. Follow the same sequence of interactions
3. Adapt values based on the current task requirements
4. Use the filter/search patterns shown for finding fields

============================================================

Now complete the current task following similar patterns. Think step by step.
