...
// extension/popup-entry.jsx
var import_react2 = __toESM(require_react());
var import_client = __toESM(require_client());

// extension/TaskRecorderPanel.jsx
...
var TaskRecorderPanel = () => {
  ...
  (0, import_react.useEffect)(() => {
    ...
    const start = Date.now() - elapsed * 1e3;
    const interval = setInterval(() => {
      setElapsed(Math.floor((Date.now() - start) / 1e3));
    }, 1e3);
    return () => clearInterval(interval);
  }, [status]);
  const buttonStates = (0, import_react.useMemo)(
    () => ({
    ...
    /* @__PURE__ */ import_react.default.createElement(
      ...
      /* @__PURE__ */ import_react.default.createElement(
        ...
        /* @__PURE__ */ import_react.default.createElement(
          ...
          {
            type: "text",
            defaultValue: "Complete the task: Click on something",
...
var TaskRecorderPanel_default = TaskRecorderPanel;

// extension/popup-entry.jsx
var mount = document.getElementById("task-recorder-root");
if (mount) {
  (0, import_client.createRoot)(mount).render(/* @__PURE__ */ import_react2.default.createElement(TaskRecorderPanel_default, null));
}
